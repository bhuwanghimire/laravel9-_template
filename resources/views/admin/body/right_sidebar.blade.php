...
<div class="navbar-right">
    <ul class="navbar-nav">
        ...
        {{-- <li><a href="{{ route('admin.change.password') }}" class="app_group_work" title="Change Password"><i class="zmdi zmdi-group-work"></i></a></li> --}}
        <li><a href="javascript:void(0);" class="js-right-sidebar" title="Setting"><i class="zmdi zmdi-settings zmdi-hc-spin"></i></a></li>
        {{-- <li><a href="{{route('admin.profile')}}" class="app_calendar" title="Profile"><i class="zmdi zmdi-account"></i></a></li> --}}
        <li>
       
        <a onclick="document.getElementById('logout').submit();" class="mega-menu" title="Sign Out"><i class="zmdi zmdi-power"></i></a>
